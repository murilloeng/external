...
extern "C"
{
	...
	void gegenbauer_ek_compute(int n, double alpha, double a, double b,double xtab[], double weight[]);
	void gegenbauer_ss_compute(int n, double alpha, double xtab[], double weight[]);
	void gegenbauer_ss_recur(double &p2, double &dp2, double &p1, double x,int order, double alpha, double c[]);
	void gegenbauer_ss_root(double &x, int order, double alpha, double &dp2, double &p1, double c[]);
	...
	void gen_laguerre_ek_compute(int order, double alpha, double xtab[], double weight[]);
	...
	void jacobi_ek_compute(int order, double alpha, double beta, double xtab[], double weight[]);
